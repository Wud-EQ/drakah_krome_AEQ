Drakah Integrated UI - Krome
Created by Drakah
Version 7.6 - December 9, 2018
Folder Name: drakah_intg_krome
shakahr.com

Now Includes Aggro Meter
http://shakahr.com/downloads/aggro-meter/
...
~ Spell Icons by Etasi
~ Spell Book by T.King
...
- Rename the "UI_Drakah_servername.ini" file from the UI folder to your Character Name and Server Name accordingly, and paste it into your EverQuest main directory. (example: UI_Drakah_xegony.ini)
- Launch EverQuest
...
- Copy the "UI_Drakah_servername.ini" file from the UI folder and paste it into your EverQuest main directory.
- Go to your Options Window, click the "Copy Layout" button, and select the UI_Drakah_tking.ini" file for your resolution, and click Copy.
- Adjust windows/filtering if needed.
